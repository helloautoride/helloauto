                ...
                if (myMarkers
                  ...
                  if (dist > 50 &&
                    ...
                    if (mapType == 'google') {
                      ...
                      printWrapped(polys.toString());
                      printWrapped(nearestLat.toString());
                                                                                        ...
                                                                                        child: (k == 0 || k == addressList.length - 1)
                                                                                            ? Column(
                                                                                                children: [
                                                                                                  ...
                                                                                                  InkWell(
                                                                                                    onTap: () {
                                                                                                      printWrapped(addressList[k].toString());
                                                                                                      // printWrapped(tripStops[k].toString());
                                                                                                    },
                                                                                                    child: Container(
            ...
            child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int i) {
                  return (tripStops[i]['completed_at'] == null)
                      ? InkWell(
                          onTap: () {
                            printWrapped(tripStops.toString());
                            setState(() {
