...
Color buttonColor = const Color(0xff0080a8);
Color theme = const Color(0xff0080a8);
...
Color loaderColor = const Color(0xff0080a8);
Color notUploadedColor = const Color(0xFF0080a8);
Color verifyPendingBck = const Color(0xffFEF2F2);
Color verifyPending = const Color(0xff0080a8);
...
Color starColor = const Color(0xff0080a8);
