...
//base url
String url =
    'https://helloauto.org/public/'; //add '/' at the end of the url as 'https://url.com/'
String mapkey =
    (platform == TargetPlatform.android) ? 'AIzaSyC2I1mta99WUwF16yOo3vAugQdkRLUxSKs' : 'AIzaSyC2I1mta99WUwF16yOo3vAugQdkRLUxSKs';
    ...
    if (response.statusCode == 200) {
      ...
      if (userDetails['role'] != 'owner') {
        ...
        if (userDetails['onTripRequest'] != null) {
          ...
          printWrapped(driverReq.toString());
...
etaRequest() async {
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      result = true;
      printWrapped(etaDetails.toString());
      valueNotifierHome.incrementNotifier();
    } else if (response.statusCode == 401) {
      result = 'logout';
    } else {
...
getPolylines(animate) async {
  ...
  if (driverReq.isEmpty ||
    ...
    printWrapped('123456788 ${driverReq['poly_line'].toString()}');
...
geolocs.LocationSettings locationSettings = (platform == TargetPlatform.android)
    ? geolocs.AndroidSettings(
        ...
        foregroundNotificationConfig:
          ...
          notificationText:
              "HelloAuto Driver will continue to receive your location in background",
